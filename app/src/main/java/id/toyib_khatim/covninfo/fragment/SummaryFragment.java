...
package id.toyib_khatim.covninfo.fragment;
...
import id.toyib_khatim.covninfo.activity.WorldHistory;
import id.toyib_khatim.covninfo.model.WorldSummaryModel;
import id.toyib_khatim.covninfo.viewmodel.WorldSummaryViewModel;
...
public class SummaryFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FrameLayout frameLayout = view.findViewById(R.id.fl_detail);
